...
```text
DL; Layer 2 - MAC(MacResourcePdu); SSI(3436244), AddressType(1), EncryptionMode(0), RandomAccessFlag(1), LengthIndication(6)
DL; Layer 3 - MM(DLocationUpdateAccept); SSI(3436244), LocationUpdateAcceptType('ITSI attach'), SubscriberClass(5), ScchInformation(8), DistributionOn18thFrame(0), LaTimer('1 hour'), La(2333)
```
